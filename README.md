...
У проєкті є готові HTML-адаптери для:
...
Якщо сайт змінить пошук або почне віддавати товари тільки через внутрішній API, потрібно оновити відповідний адаптер у папці:
